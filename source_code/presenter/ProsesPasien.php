...
class ProsesPasien implements KontrakPresenter
{
	...
	function prosesDataPasien()
	{
		try {
			...
			//memproses error
			echo "Error Proses Data Pasien" . $e->getMessage();
		}
	}
	...
	function hapusDataPasien($id)
	{
		try {
			...
			echo "Error Hapus Data Pasien" . $e->getMessage();
		}
	}
	...
	function addDataPasien($data)
	{
		try {
			...
			echo "Error Tambah Data Pasien" . $e->getMessage();
		}
	}
	...
	function editDataPasien($data)
	{
		try {
			...
			echo "Error Ubah Data Pasien" . $e->getMessage();
		}
	}
	...
	function getDataPasienById($id)
	{
		try {
			...
			echo "Error getDatapasienById" . $e->getMessage();
		}
	}
